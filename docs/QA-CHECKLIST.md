...
* [ ] **REL-03** Deployment runbook; rollback procedure; monitoring alerts active.
* [ ] **REL-04** Legal pages (Terms, Privacy, DMCA) reviewed and published.
...
See `TEST-COVERAGE-MATRIX.md` for current implementation status and gap analysis.
